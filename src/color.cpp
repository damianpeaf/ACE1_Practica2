...
void color_sequence() {
    ...
    &&  blue_frequency >=130 && blue_frequency <= 220){
        // Serial.println("POSIBLE YELLOW");
        yellow_probability++;
    }
    ...
    &&  blue_frequency >=250 && blue_frequency <= 350)  {
        // Serial.println("POSIBLE RED");
        red_probability++;
    }
    ...
    &&  blue_frequency >=50 && blue_frequency <= 130) {
        // Serial.println("POSIBLE BLUE");
        blue_probability++;
    }
    delay(100);
}
